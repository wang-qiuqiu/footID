...
# 获取所有的训练图片
TrainX = np.load('foot_data_300_bottom_train\\TrainX.npy')
TrainY = np.load('foot_data_300_bottom_train\\TrainY.npy')
TestX = np.load('foot_data_300_bottom_train\\TestX.npy')
TestY = np.load('foot_data_300_bottom_train\\TestY.npy')
...
if __name__ == '__main__':
    ...
    for i in range(50001):
        ...
        if i % 10000 == 0 and i != 0:
            foot_saver.save(sess2, 'source_300_bottom_checkpoint/%05d.ckpt' % i)
